...
import { Package, ShoppingBag, Clock, CheckCircle2, Truck, XCircle, ArrowLeft } from 'lucide-react';
            ...
            <CustomerLayout>
                <div className="mx-auto max-w-6xl px-4 py-6 pb-20 sm:px-6 sm:py-8 sm:pb-8">
                    ...
                    <div className="mb-6 sm:mb-8">
                        ...
                        <h1 className="text-2xl font-semibold text-foreground sm:text-3xl">My Orders</h1>
                    ...
                    {/* Stats Cards */}
                    <div className="mb-6 grid gap-4 sm:grid-cols-3 sm:mb-8">
                        <div className="rounded-xl border border-border bg-card p-4 shadow-sm">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xl font-semibold text-foreground">{stats.total_orders}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="rounded-xl border border-border bg-card p-4 shadow-sm">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xl font-semibold text-foreground">{stats.pending_orders}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div className="flex flex-col gap-2 text-xs sm:flex-row sm:items-center sm:justify-between">
                                                <div className="text-muted-foreground">
                                                    <p>
                                                        ...
                                                        {order.address.full}, {order.address.upazila},{' '}
                                                    ...
                                                    {Number(order.delivery_amount) > 0 && (
                                                        <div>
                                                            ...
                                                            <span className="font-medium">
                                                                {formatCurrency(order.delivery_amount)}
                                                            </span>
                                                        </div>
                                                    )}
                                                </div>
