...
export default function StoreCheckout({
    ...
    const selectedDivision =
        locations.find((d) => d.name === form.data.division) ?? null;
    const districts = selectedDivision?.districts ?? [];
    const selectedDistrict =
        districts.find((d) => d.name === form.data.district) ?? null;
                                ...
                                >
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <textarea
                                            id="address"
                                            rows={3}
                                            className="w-full rounded-lg border border-input bg-background px-3 py-2.5 text-sm transition-colors outline-none placeholder:text-muted-foreground focus:border-primary focus:ring-2 focus:ring-primary/20 disabled:cursor-not-allowed disabled:opacity-50"
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                type="tel"
                                                inputMode="numeric"
                                                className="h-11 w-full rounded-lg border border-input bg-background pr-3 pl-12 text-sm transition-colors outline-none placeholder:text-muted-foreground focus:border-primary focus:ring-2 focus:ring-primary/20 disabled:cursor-not-allowed disabled:opacity-50"
                            ...
                            <div className="rounded-xl border border-border bg-card p-5 sm:p-6 lg:max-h-[calc(100vh-6rem)] lg:overflow-y-auto">
                                ...
                                <div className="mt-5 rounded-lg border border-primary/15 bg-primary/5 p-3 text-xs text-muted-foreground">
                                    <p>
                                        ...
                                        receive a confirmation SMS. You can
