...
export default function ReceiptPaymentReport({
    report,
    filters,
}: ReceiptPaymentReportProps) {
    const form = useForm({
                ...
                <div className="report-container space-y-6">
                    ...
                    <form
                        onSubmit={(e) => {
                            e.preventDefault();
                            form.get(
                                `/admin/accounting/receipt-payment-report`,
                                {
                                    data: {
                                        from: form.data.from,
                                        to: form.data.to,
                            ...
                            <tfoot>
                                <tr className="report-total-row">
                                    ...
                                    <td className="report-td text-right font-semibold">
                                        ৳{fmt(report.total_left)}
                                    </td>
                                    <td className="report-td report-divider text-right font-semibold">
                                        ৳{fmt(report.total_left_cumulative)}
                                    </td>
                                    <td className="report-td font-semibold">
                                        Total (Right)
                                    </td>
                                    <td className="report-td text-right font-semibold">
                                        ৳{fmt(report.total_right)}
                                    </td>
                                    <td className="report-td text-right font-semibold">
                                        ৳{fmt(report.total_right_cumulative)}
                                    </td>
                                </tr>
                            </tfoot>
                        </table>
