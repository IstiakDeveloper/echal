...
export default function StockCreate({ products, flash }: Props) {
    ...
    const newAvgPrice =
        newTotalQty > 0 ? newTotalValue / newTotalQty : avgPrice;
                ...
                <div className="mx-auto max-w-2xl space-y-6">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-muted-foreground">
                            Select or search product, enter quantity and total
                            price. Average cost updates automatically.
                        </p>
                    </div>
                                    ...
                                    <div>
                                        ...
                                        <p className="font-medium">
                                            {selected.cost_price != null
                                                ? `৳${fmt(selected.cost_price)}`
                                                : '—'}
                                        </p>
                                    </div>
                                    <div>
                                        <p className="text-muted-foreground">
                                            Last entry unit price
                                        </p>
                                        <p className="font-medium">
                                            {lastUnit != null
                                                ? `৳${fmt(lastUnit)}`
